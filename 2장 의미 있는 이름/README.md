...
- [2장 의미 있는 이름](#2장-의미-있는-이름)
  - [이름 짓는 규칙 - 1. 의도를 분명히 밝혀라](#이름-짓는-규칙---1-의도를-분명히-밝혀라)
  - [이름 짓는 규칙 - 2. 그릇된 정보를 피하라](#이름-짓는-규칙---2-그릇된-정보를-피하라)
  - [이름 짓는 규칙 - 3. 의미 있게 구분하라](#이름-짓는-규칙---3-의미-있게-구분하라)
  - [이름 짓는 규칙 - 4. 발음하기 쉬운 이름을 사용하라](#이름-짓는-규칙---4-발음하기-쉬운-이름을-사용하라)
  - [이름 짓는 규칙 - 5. 검색하기 쉬운 이름을 사용하라](#이름-짓는-규칙---5-검색하기-쉬운-이름을-사용하라)
  - [이름 짓는 규칙 - 6. 인코딩을 피하라](#이름-짓는-규칙---6-인코딩을-피하라)
  - [이름 짓는 규칙 - 7. 자신의 기억력을 자랑하지 마라](#이름-짓는-규칙---7-자신의-기억력을-자랑하지-마라)
  - [이름 짓는 규칙 - 8. 클래스 이름](#이름-짓는-규칙---8-클래스-이름)
  - [이름 짓는 규칙 - 9. 메서드 이름](#이름-짓는-규칙---9-메서드-이름)
  - [이름 짓는 규칙 - 10. 기발한 이름을 피하라](#이름-짓는-규칙---10-기발한-이름을-피하라)
  - [이름 짓는 규칙 - 11. 한 개념에 한 단어를 사용하라](#이름-짓는-규칙---11-한-개념에-한-단어를-사용하라)
  - [이름 짓는 규칙 - 12. 해법 영역(기술)에서 가져온 이름을 사용하라](#이름-짓는-규칙---12-해법-영역기술에서-가져온-이름을-사용하라)
  - [이름 짓는 규칙 - 13. 문제 영역(domain)에서 가져온 이름을 사용하라](#이름-짓는-규칙---13-문제-영역domain에서-가져온-이름을-사용하라)
  - [이름 짓는 규칙 - 14. 의미 있는 맥락을 추가하라](#이름-짓는-규칙---14-의미-있는-맥락을-추가하라)
  - [이름 짓는 규칙 - 15. 불필요한 맥락을 없애라](#이름-짓는-규칙---15-불필요한-맥락을-없애라)
  - [마지막으로](#마지막으로)
